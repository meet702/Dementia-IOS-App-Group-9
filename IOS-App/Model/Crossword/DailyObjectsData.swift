...
let dailyObjectsData: [CrosswordData] = [
    ...
    CrosswordData(name: "SOAP", clue: "Cleaning bar"),
    CrosswordData(name: "COMB", clue: "Hair tool"),
    CrosswordData(name: "KEYS", clue: "Door openers"),
    CrosswordData(name: "BOWL", clue: "Food container"),
    ...
    CrosswordData(name: "BRUSH", clue: "Cleaning tool"),
    CrosswordData(name: "CLOCK", clue: "Time teller"),
    CrosswordData(name: "KNIFE", clue: "Cutting tool"),
    CrosswordData(name: "SPOON", clue: "Soup utensil"),
    ...
    CrosswordData(name: "WALLET", clue: "Money holder"),
    CrosswordData(name: "BUCKET", clue: "Water carrier"),
    CrosswordData(name: "PENCIL", clue: "Writing tool"),
    CrosswordData(name: "ERASER", clue: "Mistake remover"),
    ...
    CrosswordData(name: "SPEAKER", clue: "Sound device"),
