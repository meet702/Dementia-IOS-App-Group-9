...
let foodData: [CrosswordData] = [
    ...
    CrosswordData(name: "FISH", clue: "Swimming food"),
    CrosswordData(name: "PORK", clue: "Pig meat"),
    ...
    CrosswordData(name: "SALAD", clue: "Vegetable mix"),
    CrosswordData(name: "CURRY", clue: "Spicy dish"),
    CrosswordData(name: "STEAK", clue: "Grilled meat"),
    CrosswordData(name: "BACON", clue: "Crispy breakfast meat"),
    ...
    CrosswordData(name: "NOODLE", clue: "Asian pasta"),
    CrosswordData(name: "POTATO", clue: "Underground vegetable"),
    CrosswordData(name: "TOMATO", clue: "Red vegetable"),
    CrosswordData(name: "CARROT", clue: "Orange vegetable"),
